...
import { TopBar, ShopAppWrapper, HeaderTitle, HeaderMenu, SearchInput } from './ShopApp.styled';
            ...
            <div className="Header">
                ...
                <HeaderMenu>
                    <div className="searchSection">
                        ...
                        <Icon src={searchIcon.d} name={'search-icon'} width='32px' height='32px' fill="#fff" viewbox={'0 0 24 24'} />
                    </div>   
                    
                    <div className="items">
                        <Icon src={carIcon.d}  viewbox={'0 0 512 512'} fill="#a68a64" width="40px" height="40px"/>
                    </div>
